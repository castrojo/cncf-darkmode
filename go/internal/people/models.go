...
// CRITICAL: email and wechat are never included in SafePerson.
...
// ToSafePerson is the package-level alias for ToSafe — used in tests.
func ToSafePerson(p RawPerson) SafePerson {
return p.ToSafe()
}
...
// CountryFlag derives a flag emoji from a freeform location string.
...
Bio               string          `json:"bio,omitempty"`
Projects          []string        `json:"projects"`
ProjectDetails    []ProjectDetail `json:"projectDetails,omitempty"`
Maturity          string          `json:"maturity"`
AvatarURL         string          `json:"avatarUrl,omitempty"`
